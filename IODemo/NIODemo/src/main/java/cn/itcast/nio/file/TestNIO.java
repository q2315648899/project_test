...
public class TestNIO {
    ...
    public void  test1() throws  Exception{
        //1. 创建输出流
        FileOutputStream fos=new FileOutputStream("NIODemo\\basic.txt");
        //2. 从流中得到一个通道
    ...
    public void test2() throws  Exception{
        File file=new File("NIODemo\\basic.txt");
        //1. 创建输入流
    ...
    public void test3() throws  Exception{
        //1. 创建两个流
        FileInputStream fis=new FileInputStream("NIODemo\\basic.txt");
